...
Core Functionality
Token Staking: Stake WMON for a lock period (min 1 day, no max), with automatic share calculation for rewards.
Time-Locked Staking: Choose lock duration; longer locks = better rewards. Early withdrawal incurs a 5% penalty.
Fee Structure:
...
Up to 10 owners
Owners can add/remove other owners, configure tokens, update fees, pause/unpause, update metadata
🔧 Key Features
V1 Features
...
Early withdrawal possible (5% penalty)
4. Withdraw
...
Earn automatically: When they stake using your address, you get 20% of fees
Track rewards: Check your accumulated rewards anytime
Claim anytime: Rewards are tracked on-chain
For Administrators
...
Update Metadata
await vault.setMetadata("https://your-metadata-uri", "New Vault Name", "NEW");
...
Upgradeable: UUPS proxy, only owner can upgrade
OpenZeppelin libraries: Reentrancy, overflow, zero address, and balance checks
📈 Use Cases
Liquidity Mining: Stake WMON, provide liquidity, earn Uniswap V3 fees
Token Holding Incentive: Lock tokens, reduce circulating supply, reward long-term holders
Referral Marketing: Grow community, incentivize promotion, track performance on-chain
Governance Participation: Multi-owner system for DAOs, decentralized decision making
...
Events Emitted
event TokenStaked(address indexed user, uint256 indexed stakeId, address indexed token, uint256 amount, uint256 unlockTime, address referrer);
event StakeWithdrawn(address indexed user, uint256 indexed stakeId, uint256 amount, uint256 reward);
event TokenConfigured(address indexed token, string name, string symbol, uint24 fee, address pairedToken, uint256 minLiquidity);
event ReferrerRewardPaid(address indexed referrer, address indexed token, uint256 amount);
...
📞 Support & Links
V2 Proxy on MonadVision
V2 Implementation on MonadVision
Monad Docs: https://docs.monad.xyz
Uniswap V3 Docs: https://docs.uniswap.org/protocol/V3
OpenZeppelin Contracts: https://docs.openzeppelin.com
Owner: 0x592B35c8917eD36c39Ef73D0F5e92B0173560b2e
Donate: moon.monad.xyz/donate/0x592B35c8917eD36c39Ef73D0F5e92B0173560b2e
⚠️ Disclaimer
